// NOTE: (Vizonex) gonna include a few things to prevent errors...

/* Now Maintained by Vizonex as of 3-25-2025 */
/* CODE: https://github.com/Alexpux/mingw-w64/blob/master/mingw-w64-crt/misc/mkstemp.c */
